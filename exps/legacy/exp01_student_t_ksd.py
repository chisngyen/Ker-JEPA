...
class LeJEPA_StudentT(nn.Module):
...
def main():
    print("\n" + "🚀 REPRODUCE: LEJEPA (STUDENT-T INNOVATION) | 50+50 EPOCHS".center(60, "="))
    ...
    model = LeJEPA_StudentT().to(device)
    ...
    save_path = "models/sota_climb_latest.pth"
    ...
    print("\n" + "═"*60)
    print(f"🎯 FINAL INNOVATION REPORT: {best_acc:.2f}%")
    print("═"*60)
